    ...
    if($_POST['action'] == "addtocart")
    {
        ...
        if (isset($_SESSION['ccart']))
        {
            ...
            for ($k = 0; $k < $cartcount; $k++) {
                ...
                // echo "<h1>tickttype:</h1>".$ticketType;
                if ($ticketType === 'ADULT') {
            ...
            if(isset($_POST['tickettype']) && strtoupper($_POST['tickettype']) == 'CHILD'){
              $childrens += $_POST['quantity'];
            }

            $totalallowedchildrens =  ($adults + $senior)*4;
            // echo "<br>adultsCount :".$adultsCount; 
            // echo "<br>childrensCount :".$childrensCount;
            // echo "<br>totalallowedchildrens :".$totalallowedchildrens; 
            // echo "<br>adults :".$adults; 
            // echo "<br>childrens :".$childrens; 
            // echo "<br>senior :".$senior; 
            // echo "<br><pre>POST: ";print_r($_POST); echo "</pre>";
// die;
...
foreach ($cart as $item) {
    ...
    // if (strtoupper(trim($item->tickettype)) == strtoupper('CHILD') || strtoupper(trim($item->tickettype)) == strtoupper('SENIOR CITIZEN')) {
    //     $message = "Children (Below 15 years) and Sr. Citizens (60 years and above) must carry ID proof issued by Govt.";
    // }
